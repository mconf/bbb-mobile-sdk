...
const previousPollPublishedSlice = createSlice({
  ...
  reducers: {
    addPreviousPollPublished: (state, action) => {
      ...
      state.previousPollPublishedCollection[previousPollPublishedObject._id] = action.payload.previousPollPublishedObject.extra.pollResultData;
    },
    addPreviousPollPublishedViaChat: (state, action) => {
      const { previousPollPublishedObject } = action.payload;
      state.previousPollPublishedCollection[previousPollPublishedObject.id] = action.payload.previousPollPublishedObject.fields.extra.pollResultData;
    },
...
export const { addPreviousPollPublished, addPreviousPollPublishedViaChat } = previousPollPublishedSlice.actions;
