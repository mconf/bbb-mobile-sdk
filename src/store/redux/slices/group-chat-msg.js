...
const groupChatMsgSlice = createSlice({
  ...
  reducers: {
    addGroupChatMsgBeforeJoin: (state, action) => {
      ...
      state.groupChatMsgCollection[`${groupChatMsgObject.id}${groupChatMsgObject.timestamp}`] = action.payload.groupChatMsgObject;
    },
    ...
    addGroupChatMsg: (state, action) => {
      const { groupChatMsgObject } = action.payload;
      state.groupChatMsgCollection[groupChatMsgObject.id] = action.payload.groupChatMsgObject.fields;
    },
